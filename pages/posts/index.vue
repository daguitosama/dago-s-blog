        ...
        >
            <NuxtErrorBoundary @error="onError">
                ...
                >
                    ...
                    <main
                        class="max-w-2xl mx-auto prose-headings:mx-[30px] prose-headings:font-bespoke prose-h1:text-4xl md:prose-h1:text-5xl md:prose-h1:leading-tight prose-p:mx-[30px]"
                    >
                        <h1 class="text-4xl sm:text-5xl font-extrabold">Posts</h1>

                        <PostList class="mt-[20px]" />
                    </main>
                    <TheFooter />
                </Body>
            </NuxtErrorBoundary>
